...
// => Checks only one thing at once
// A method that requires an array of n elements has a linear space complexity of O(n).
// => Checks every number / thing

// ==> Perhaps this question wants us to check all elements, but only one at once?
// Two pointer technique?!

const duplicateNumberExtension = (array: number[]): number => {
...
console.log(duplicateNumberExtension([3, 4, 7, 6, 8, 5, 6]))
;
