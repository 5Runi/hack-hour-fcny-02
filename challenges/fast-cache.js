 ...
 * 2. Output: It returns a new function that has the same signature as `fn`.// This means if `fn` is of type (arg: T) => R, the returned function should also be of type (arg: T) => R.
